...
class ProductsController < ApplicationController
  ...
  #@products = Product.all
    ...
    @products.each do |product|
      ...
      item = Product.find_by(sku: product["sku"])
      item ||= Product.create( sku: product["sku"], photo_url: product["photo_url"], title: product["title"], description: product["description"], price: product["price"])
